...
sub compile {
    ...
    eval "sub { my \$$Token = ''; $tmpl \$$Token }"
        or croak "ERROR: Cannot compile template: $@";
}
sub render {
...
sub add_header_file {
    ...
    $self->print("/* This file was automatically generated by $0. *DO NOT MODIFY* this file directly. */\n");
    my $ucname = uc $name;
...
sub finalize {
    ...
    for my $header (@{ $self->{headers} || [] }) {
        ...
        my $file = File::Spec->catfile($ENV{PWD}, 'libvirt.gen', "$name.h");
        open my $fh, '>', $file
